  ...
  <Frame>
    ...
    <div style={{padding: '24px 36px', height: 'calc(100% - 60px)', overflow: 'hidden'}}>
      ...
      <div style={{display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 16, marginTop: 28, alignItems: 'end'}}>
        {[
          ...
          <div key={s.p} style={{textAlign: 'center'}}>
            ...
            <div style={{marginTop: 10, height: s.h, border: '1.5px solid var(--ink)', background: s.color, borderRadius: '6px 6px 0 0', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'Caveat', fontSize: 44, fontWeight: 700, color: s.p === 1 ? '#fff' : 'var(--ink)'}}>{s.p}</div>
          </div>
        ))}
      </div>
      ...
      <Box style={{padding: 0, marginTop: 6, overflow: 'hidden'}}>
        {[
          {p: 4, a: 'BL', n: 'Bia Lopes', role: 'Design · Lvl 9', pts: '1,160', d: '+340', new: true},
          {p: 5, a: 'TR', n: 'Tiago Reis', role: 'Eng · Lvl 6', pts: '980', d: '+220'},
          {p: 6, a: 'CM', n: 'Carla M.', role: 'Eng · Lvl 11', pts: '920', d: '+180'},
          {p: 7, a: 'FM', n: 'Você (Fabio)', role: 'Lvl 7', pts: '840', d: '+47', me: true},
          {p: 8, a: 'NS', n: 'Nina Souza', role: 'Lvl 5', pts: '720', d: '+90'},
          {p: 9, a: 'RB', n: 'Rui B.', role: 'Lvl 8', pts: '680', d: '+30'},
        ].map(r => (
            ...
            <svg width="100%" height="100%" viewBox="0 0 600 350" style={{position: 'absolute'}}>
              ...
              {[
                ...
                <g key={i}>
                  ...
                  <text x="80" y={t.y + 30} fontFamily="Caveat" fontSize="22" fontWeight="600" fill={i < 2 ? '#fff' : '#1a1816'}>{t.label}</text>
                  <text x="80" y={t.y + 46} fontFamily="Geist Mono" fontSize="10" fill={i < 2 ? '#fff' : '#1a181699'}>{t.need} pts · {t.count} membros</text>
                  {t.me && <text x="510" y={t.y + 32} fontFamily="Caveat" fontSize="20" fill="#ff5a1f" transform={`rotate(-2, 510, ${t.y+32})`}>← você</text>}
                </g>
              ))}
            </svg>
          </div>
          <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: 12}}>
            <Mono style={{color: 'var(--ink-mid)'}}>FALTAM <b style={{color: 'var(--accent)'}}>1,160 pts</b> PRO OURO</Mono>
        ...
        <div style={{display: 'flex', flexDirection: 'column', gap: 12}}>
          <Box style={{padding: 14, background: '#fff7ee', borderColor: 'var(--ink)'}}>
            <div style={{display: 'flex', gap: 10, alignItems: 'center'}}>
              ...
              <div style={{flex: 1}}>
                ...
                <Mono style={{display: 'block', color: 'var(--ink-mid)'}}>Posição #7 · 840 pts</Mono>
              </div>
              <LvlBadge lvl={7} />
            </div>
            <Mono style={{color: 'var(--ink-mid)', marginTop: 12, display: 'block'}}>SEU NÍVEL · 7</Mono>
            <Bar pct={62} style={{marginTop: 4}} />
            <Mono style={{color: 'var(--ink-mid)', display: 'block', marginTop: 4}}>240 pts pro lvl 8</Mono>
          </Box>
          ...
          <Box style={{padding: 12}}>
            ...
            <div style={{display: 'flex', flexDirection: 'column', gap: 6, marginTop: 8, fontSize: 12.5}}>
              ...
              <div>🎓 Terminar uma lição · <Mono style={{color: 'var(--accent)'}}>+12</Mono></div>
            </div>
          </Box>
        </div>
      </div>
  ...
  <Frame>
    ...
    <div style={{padding: '24px 36px', height: 'calc(100% - 60px)', overflow: 'hidden'}}>
      ...
      <div style={{display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 14, marginTop: 18}}>
        {[
          {p: 1, a: 'MR', n: 'Maria Ribeiro', role: 'Eng · Lvl 12', pts: 2140, badges: ['🔥', '💡', '🎓'], q: 'respondeu 14 perguntas + 2 cursos finalizados', color: 'var(--accent)', text: '#fff'},
          {p: 2, a: 'JS', n: 'João Santos', role: 'Design · Lvl 8', pts: 1820, badges: ['🎨', '👥'], q: 'compartilhou 3 showcases', color: 'var(--accent-2)', text: 'var(--ink)'},
          {p: 3, a: 'DK', n: 'Davi Klein', role: 'PM · Lvl 15', pts: 1420, badges: ['📣', '🚀'], q: 'organizou a live de roadmap', color: 'var(--paper-2)', text: 'var(--ink)'},
        ].map(c => (
