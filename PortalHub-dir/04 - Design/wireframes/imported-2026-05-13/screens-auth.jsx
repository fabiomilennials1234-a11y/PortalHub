    ...
    <div style={{display: 'flex', alignItems: 'center', justifyContent: 'center', height: 'calc(100% - 40px)', padding: 40, position: 'relative'}}>
      <div style={{width: 380}}>
        <div style={{textAlign: 'center', marginBottom: 24}}>
          <div style={{width: 44, height: 44, borderRadius: 10, background: 'var(--accent)', border: '1.5px solid var(--ink)', margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', fontFamily: 'Caveat', fontSize: 28, fontWeight: 700}}>P</div>
    ...
    <div style={{display: 'grid', gridTemplateColumns: '1fr 1fr', height: '100%'}}>
      ...
      <div style={{padding: '36px 50px', display: 'flex', flexDirection: 'column', justifyContent: 'center', borderRight: '1.5px solid var(--ink)'}}>
        <div style={{display: 'flex', alignItems: 'center', gap: 8, marginBottom: 30}}>
          <div style={{width: 32, height: 32, borderRadius: 8, background: 'var(--accent)', border: '1.5px solid var(--ink)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', fontFamily: 'Caveat', fontSize: 22, fontWeight: 700}}>P</div>
      ...
      <div style={{padding: '30px 36px', background: 'var(--paper-2)', position: 'relative', display: 'flex', flexDirection: 'column', justifyContent: 'center'}}>
        ...
        <div style={{marginTop: 14, display: 'grid', gap: 10}}>
          {[
            ...
            ['⚡', 'Você subiu pra nível 7', 'Próximo: 240 pts pro nível 8', 'há 1d'],
            ['JS', 'João começou um curso', 'Design Systems · módulo 3', 'há 3h'],
            ['📅', '"Live de roadmap" começa em 1h', 'Você tem RSVP', 'hoje'],
          ].map(([i, t, s, w], idx) => (
  ...
  <Frame>
    ...
    <div style={{padding: '40px 60px', height: 'calc(100% - 40px)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center'}}>
      ...
      <Hand size={54} style={{textAlign: 'center', lineHeight: 1}}>
        Qual seu <span className="wf-mark">email</span>?
      </Hand>
      ...
      <div style={{display: 'flex', alignItems: 'center', gap: 14, marginTop: 36}}>
        {[1, 2, 3].map(n => (
          <div key={n} style={{display: 'flex', alignItems: 'center', gap: 8}}>
            <div style={{width: 26, height: 26, border: '1.5px solid var(--ink)', borderRadius: '50%', background: n === 1 ? 'var(--accent)' : 'var(--paper)', color: n === 1 ? '#fff' : 'var(--ink)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'Caveat', fontWeight: 700, fontSize: 14}}>{n}</div>
