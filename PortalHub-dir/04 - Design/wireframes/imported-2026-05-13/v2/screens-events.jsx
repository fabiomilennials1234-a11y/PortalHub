    ...
    <div style={{padding: '24px 36px', height: 'calc(100% - 60px)', overflow: 'hidden'}}>
      ...
      <div style={{display: 'grid', gridTemplateColumns: '1.4fr 1fr', gap: 18, marginTop: 16, height: 'calc(100% - 80px)'}}>
        ...
        <div style={{display: 'flex', flexDirection: 'column', gap: 10, overflow: 'hidden'}}>
          ...
          {[
            {d: '12 mai · 19h', t: 'Roadmap Q3 com a liderança', host: 'Davi K.', rsvp: 42, joined: true, hot: true},
            {d: '17 mai · 14h', t: 'AMA com Maria — Discovery — discovery enterprise', host: 'Maria R.', rsvp: 28},
            {d: '20 mai · 19h', t: 'Mesa redonda: pricing de SaaS B2B', host: 'João S.', rsvp: 15},
            {d: '24 mai · 10h', t: 'Workshop: Vendas consultivas B2B hands-on', host: 'Bia L.', rsvp: 67, premium: true},
          ].map((e, i) => (
            <Box key={i} style={{padding: 12, background: e.joined ? '#fff7ee' : 'var(--paper)', borderColor: e.joined ? 'var(--ink)' : 'var(--line)'}}>
              <div style={{display: 'flex', alignItems: 'center', gap: 8}}>
                ...
                {e.hot && <Pill yellow style={{fontSize: 9, padding: '1px 5px'}}>Esgotado</Pill>}
                {e.premium && <Pill yellow style={{fontSize: 9, padding: '1px 5px'}}>Enterprise</Pill>}
                <div style={{flex: 1}} />
  ...
  <Frame>
    ...
    <div style={{padding: '24px 36px', height: 'calc(100% - 60px)', overflow: 'hidden'}}>
      ...
      <Box style={{padding: 14, marginTop: 14, background: 'var(--accent)', color: '#fff', borderColor: 'var(--ink)', display: 'flex', alignItems: 'center', gap: 14}}>
        ...
        <Hand size={22} style={{color: '#fff'}}>EM TRANSMISSÃO AGORA</Hand>
        <span style={{flex: 1, color: '#fff', fontWeight: 500}}>"Office Hours · Pipeline review" — Davi K. · 12 ouvindo</span>
      ...
      <div style={{display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 14, marginTop: 8}}>
        {[
          {dd: '12', mm: 'MAI', d: 'hoje · 19h', t: 'Roadmap Q3 com a liderança', desc: '1h · Davi K. apresenta o trimestre', rsvp: 42, joined: true, color: 'var(--accent)'},
          {dd: '17', mm: 'MAI', d: 'sex · 14h', t: 'AMA com Maria — Discovery', desc: 'tudo sobre discovery enterprise + RLS', rsvp: 28, color: 'var(--accent-2)'},
          {dd: '20', mm: 'MAI', d: 'seg · 19h', t: 'Pricing de SaaS B2B', desc: 'João S. abre os números reais', rsvp: 15, color: 'var(--paper-2)'},
          {dd: '24', mm: 'MAI', d: 'sex · 10h', t: 'Workshop Vendas consultivas B2B', desc: '3h hands-on · max 30 vagas', rsvp: 27, max: 30, premium: true, color: 'var(--paper-2)'},
          {dd: '28', mm: 'MAI', d: 'ter · 17h', t: 'Demo day · vendedores apresentam casos', desc: 'mostre o que está construindo', rsvp: 8, color: 'var(--paper-2)'},
          {dd: '03', mm: 'JUN', d: 'qua · 20h', t: 'Mesa: panorama B2B do mês', desc: 'painel com 4 fundadores', rsvp: 31, color: 'var(--paper-2)'},
        ].map((e, i) => (
          <Box key={i} style={{padding: 0, overflow: 'hidden'}}>
            ...
            <div style={{padding: '8px 14px', borderTop: '1.5px dashed var(--line-soft)', display: 'flex', alignItems: 'center', gap: 8}}>
              ...
              <div style={{flex: 1}} />
              {e.premium && <Pill yellow style={{fontSize: 9, padding: '1px 5px'}}>ENT</Pill>}
