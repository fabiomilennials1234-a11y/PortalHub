  ...
  <Frame>
    ...
    <div style={{padding: '24px 36px', height: 'calc(100% - 60px)', overflow: 'hidden'}}>
      ...
      <div style={{display: 'flex', flexDirection: 'column', gap: 6, marginTop: 8}}>
        {[
          {a: 'MR', t: 'Maria respondeu seu post', desc: '"+1 nessa abordagem. Já tentei e…"', tag: 'discovery enterprise', w: '14min', unread: true},
          {a: 'DK', t: 'Davi mencionou você', desc: '"@fabio chequei sua PR — comentei lá"', w: '2h', unread: true, mention: true},
          {a: '●', t: 'Certificação intermediária concluída', desc: 'Discovery de alto valor · módulo 3', w: '4h', unread: true, gam: true},
          {a: '◷', t: 'Live "Roadmap Q3" começa em 1h', desc: 'Você tem RSVP · 42 confirmados', w: '5h', unread: true, event: true},
          {a: '◇', t: 'Próxima lição liberada', desc: '"Forms e composição" · Vendas consultivas B2B · M3', w: '6h'},
          {a: 'BL', t: 'Bia reagiu ao seu post', desc: 'em "Quando dar desconto"', w: '7h'},
        ].map((n, i) => (
          <Box key={i} style={{
            ...
            <Av sm style={{background: n.gam ? 'var(--gold-bg)' : n.event ? 'var(--paper-2)' : n.mention ? 'var(--ink)' : 'var(--paper-2)', color: n.mention ? 'var(--paper)' : 'var(--ink)', borderColor: n.gam ? 'var(--gold)' : 'var(--line)'}}>{n.a}</Av>
      ...
      <Box style={{padding: 12, marginTop: 8, display: 'flex', gap: 12, alignItems: 'center'}}>
        ...
        <div style={{flex: 1}}>
          ...
          <Mono style={{color: 'var(--ink-mid)'}}>· Head of GTM · Tier 8</Mono>
        </div>
      ...
      <div style={{marginTop: 26, display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 18}}>
        <Box style={{padding: 14}}>
          ...
          <div style={{display: 'flex', flexDirection: 'column', gap: 8, marginTop: 10}}>
            {[
              {a: 'MR', n: 'Maria', t: '"+1 nessa abordagem…"', on: '"discovery enterprise"'},
        ...
        <Box style={{padding: 14}}>
          <div style={{display: 'flex', alignItems: 'baseline', gap: 8}}>
            ...
            <Mono style={{color: 'var(--ink-mid)'}}>+47 créditos hoje</Mono>
          </div>
          <div style={{display: 'flex', flexDirection: 'column', gap: 8, marginTop: 10, fontSize: 12.5}}>
            ...
            <div style={{display: 'flex'}}><span style={{flex: 1}}>Postou em #Q&A</span><Mono style={{color: 'var(--accent)'}}>+8</Mono></div>
            <div style={{display: 'flex'}}><span style={{flex: 1}}>Dia consecutivo de atividade</span><Mono style={{color: 'var(--accent)'}}>+3</Mono></div>
          </div>
          <div style={{marginTop: 12, padding: 10, background: '#fff7ee', borderRadius: 6, border: '1.5px dashed var(--ink)'}}>
            ...
            <Hand size={18}>240 créditos pro nível 8 </Hand>
          </div>
        </Box>

        <Box style={{padding: 14, gridColumn: 'span 2'}}>
          <div style={{display: 'flex', alignItems: 'baseline', gap: 8}}>
            <Hand size={22}>Agenda · hoje e amanhã</Hand>
          </div>
          <div style={{display: 'flex', gap: 12, marginTop: 10}}>
            <Box style={{padding: 10, flex: 1, background: '#fff7ee'}}>
              <Mono style={{color: 'var(--accent)'}}>HOJE · 19h · em 1h12min</Mono>
              <Hand size={18} style={{display: 'block', marginTop: 2}}>Roadmap Q3 com a liderança</Hand>
            ...
            <Box style={{padding: 10, flex: 1}}>
              ...
              <Hand size={18} style={{display: 'block', marginTop: 2}}>AMA com Maria — Discovery</Hand>
              <Btn sm style={{marginTop: 6}}>RSVP</Btn>
            </Box>
            <Box style={{padding: 10, flex: 1}}>
              <Mono style={{color: 'var(--ink-mid)'}}>SEX · 10h</Mono>
              <Hand size={18} style={{display: 'block', marginTop: 2}}>Workshop · Vendas B2B</Hand>
              <Mono style={{color: 'var(--ink-mid)'}}>ENTERPRISE · 27/30 vagas</Mono>
            </Box>
          </div>
        </Box>
      </div>
