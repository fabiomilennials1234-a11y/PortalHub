    ...
    <div style={{display: 'grid', gridTemplateColumns: '1fr 280px', height: 'calc(100% - 60px)'}}>
      <div style={{padding: '24px 48px', overflow: 'hidden'}}>
        <div style={{fontSize: 12.5, color: 'var(--ink-mid)', marginBottom: 12}}>
          <span>← Feed</span> · <Pill style={{fontSize: 10.5, padding: '2px 8px'}}> Q&A</Pill> · <Mono>há 2h</Mono>
        </div>
        <Hand size={36} style={{display: 'block'}}>Como vocês fazem discovery em deals de R$ 500k+?</Hand>
        <div style={{display: 'flex', alignItems: 'center', gap: 10, marginTop: 14}}>
          <Av>MR</Av>
          <div>
            <div style={{fontSize: 13, fontWeight: 600}}>Maria Ribeiro</div>
            <Mono style={{color: 'var(--ink-mid)'}}>VP Sales · Tier 12 · 3.4k pts</Mono>
          </div>
          <div style={{flex: 1}} />
          <Btn sm>seguir</Btn>
        </div>
        ...
        <div style={{display: 'flex', gap: 14, alignItems: 'center', marginTop: 14, paddingTop: 12, borderTop: '1.5px dashed var(--line-soft)'}}>
          ...
          <Btn sm>12 comentários</Btn>
          <Pill>↑ 12 úteis</Pill>
          <Pill>★ 4 destaques</Pill>
          <Pill ghost>+ marcar</Pill>
          <div style={{flex: 1}} />
          <Mono style={{color: 'var(--ink-mid)'}}>+8 créditos ao responder</Mono>
        </div>
        ...
        <Box style={{marginTop: 22, padding: 12}}>
          ...
          <div style={{minHeight: 60, border: '1.5px dashed var(--line-soft)', borderRadius: 6, padding: 10, fontSize: 13, color: 'var(--ink-low)'}}>Comente algo útil — quanto mais útil, mais créditos</div>
        ...
        <div style={{display: 'flex', flexDirection: 'column', gap: 12, marginTop: 18}}>
          ...
          {[
            {a: 'DK', n: 'Davi Klein', role: 'Tier 15', t: 'há 1h', body: 'Fui de org_id em tudo + RLS forte. Funcionou bem até ~80 tenants. Schemas separados só faz sentido se você tem requisitos de compliance ou tenants gigantes.', up: 21, best: true},
            {a: 'BL', n: 'Bia Lopes', role: 'Tier 9', t: 'há 50min', body: 'Eu testei os dois. Schemas separados é uma dor pra migrations — toda alteração roda em N schemas. RLS é mais limpo no longo prazo.', up: 14},
            {a: 'TR', n: 'Tiago Reis', role: 'Tier 6', t: 'há 30min', body: 'Curiosidade: como vocês lidam com queries cross-tenant pra admin?', up: 5, depth: 1},
          ].map((r, i) => (
      ...
      <div style={{padding: 16, borderLeft: '1.5px dashed var(--line-soft)', display: 'flex', flexDirection: 'column', gap: 14}}>
        ...
        <div>
          ...
          <div style={{display: 'flex', flexDirection: 'column', gap: 6, marginTop: 8}}>
            {['"Quando dar desconto no fechamento"', '"Migrations com 30+ tenants"', '"Auth: clerk vs supabase"'].map((t, i) => (
          ...
          <Box style={{padding: 10, marginTop: 8}}>
            <div style={{display: 'flex', gap: 8, alignItems: 'center'}}>
              ...
              <div>
                ...
                <Mono style={{display: 'block', color: 'var(--ink-mid)'}}>VP Sales · Tier 12</Mono>
              </div>
            </div>
            <div style={{display: 'flex', gap: 10, marginTop: 8, fontSize: 12, color: 'var(--ink-mid)'}}>
              <span>47 posts</span> <span>· 312 respostas</span>
            </div>
...
const PostDocMargin = () => (
  <Frame>
    ...
    <div style={{padding: '24px 50px', overflow: 'hidden', height: 'calc(100% - 60px)'}}>
      <Mono style={{color: 'var(--ink-mid)'}}>← polaris/exec-circle · #pergunta · há 2h</Mono>
      <div style={{display: 'grid', gridTemplateColumns: '1fr 280px', gap: 36, marginTop: 14}}>
        {/* Document */}
        <div>
          <Hand size={46} style={{lineHeight: 1, display: 'block'}}>Como vocês modelam<br/>discovery enterprise no Supabase?</Hand>
          <div style={{display: 'flex', alignItems: 'center', gap: 10, marginTop: 16, fontSize: 13}}>
            <Av sm>MR</Av><b>Maria Ribeiro</b><Mono style={{color: 'var(--ink-mid)'}}>· Tier 12 · há 2h</Mono>
          </div>
          <div style={{fontSize: 15, color: 'var(--ink-soft)', lineHeight: 1.65, marginTop: 18, fontFamily: 'Geist, serif'}}>
            Tô na dúvida entre <span style={{background: 'transparent', borderBottom: '2px solid var(--gold)', padding: '0 1px'}}>coluna <b>org_id</b> em tudo</span> vs <b>schemas separados</b>. Quem já passou pelos dois caminhos? Quais foram os <span className="wf-underline-soft">trade-offs reais</span> em produção?<br/><br/>
            Pra contexto: ~50 tenants previstos, escala média.<br/><br/>
            Já vi defesas de ambos os lados, mas todas teóricas.<span style={{background: 'transparent', borderBottom: '2px solid var(--gold)', padding: '0 1px', fontWeight: 600}}> Queria histórias reais.</span>
          </div>
  ...
  <Frame>
    ...
    <div style={{padding: '20px 60px', height: 'calc(100% - 60px)', overflow: 'hidden'}}>
      <div style={{display: 'flex', gap: 12, alignItems: 'center'}}>
        <Pill yellow>Q&A · resolvida</Pill>
      ...
      <Hand size={42} style={{display: 'block', marginTop: 18}}>Como vocês fazem discovery em deals de R$ 500k+?</Hand>
      ...
      <div style={{display: 'grid', gridTemplateColumns: '60px 1fr', gap: 18, marginTop: 22}}>
        ...
        <div>
          <div style={{display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8, fontSize: 12.5}}>
            <Av sm>MR</Av><b>Maria Ribeiro</b><Mono style={{color: 'var(--ink-mid)'}}>· VP Sales · Tier 12</Mono>
          </div>
      ...
      <Box style={{marginTop: 24, padding: 18, background: '#fff7ee', borderColor: 'var(--ink)'}}>
        ...
        <div style={{display: 'grid', gridTemplateColumns: '60px 1fr', gap: 18, marginTop: 12}}>
          ...
          <div>
            <div style={{display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8, fontSize: 12.5}}>
              <Av sm>DK</Av><b>Davi Klein</b><Mono style={{color: 'var(--ink-mid)'}}>· Tier 15 · há 1h</Mono>
              <Pill yellow style={{fontSize: 10, marginLeft: 8}}>+15 créditos</Pill>
            </div>
