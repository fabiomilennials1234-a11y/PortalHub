  ...
  <Frame>
        ...
        {[
          ...
          <React.Fragment key={s.n}>
            <div style={{display: 'flex', alignItems: 'center', gap: 6}}>
              <div style={{width: 26, height: 26, borderRadius: '50%', border: '1.5px solid var(--ink)', background: s.d ? 'var(--accent)' : s.c ? '#fff7ee' : 'var(--paper)', color: s.d ? '#fff' : 'var(--ink)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'Caveat', fontSize: 16, fontWeight: 700}}>{s.d ? '✓' : s.n}</div>
    ...
    <div style={{padding: '36px 60px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 40, height: 'calc(100% - 150px)'}}>
        ...
        <div style={{marginTop: 28, display: 'flex', flexDirection: 'column', gap: 18}}>
          <div>
            ...
            <div style={{display: 'flex', gap: 10, alignItems: 'center', marginTop: 6}}>
              <div style={{width: 64, height: 64, borderRadius: 12, background: 'var(--accent)', border: '1.5px solid var(--ink)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', fontFamily: 'Caveat', fontSize: 40, fontWeight: 700}}>D</div>
              <div>
                <Btn sm>Upload</Btn>
          ...
          <div>
            ...
            <div className="wf-input" style={{marginTop: 6, padding: '10px 14px'}}>
              ...
              <span style={{flex: 1, fontFamily: 'Geist Mono', fontSize: 13, color: 'var(--ink)'}}>dev-circle</span>
      ...
      <div>
        ...
        <Box style={{padding: 0, overflow: 'hidden', marginTop: 8, transform: 'rotate(0.5deg)'}}>
          <div style={{padding: 14, borderBottom: '1.5px solid var(--line)', display: 'flex', alignItems: 'center', gap: 10}}>
            <div style={{width: 28, height: 28, borderRadius: 6, background: 'var(--accent)', border: '1.5px solid var(--ink)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', fontFamily: 'Caveat', fontSize: 18, fontWeight: 700}}>D</div>
            <Hand size={20}>dev-circle</Hand>
          </div>
          <div style={{padding: 14}}>
            <Ph w="100%" h={80} img label="// banner //" />
            <Hand size={20} style={{display: 'block', marginTop: 10}}>Bem-vindo ao dev-circle</Hand>
      ...
      <div style={{flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', maxWidth: 620, margin: '0 auto', width: '100%'}}>
        ...
        <div style={{display: 'flex', flexDirection: 'column', gap: 16}}>
          ...
          <div style={{display: 'flex', gap: 12, alignItems: 'flex-start'}}>
            <div style={{width: 36, height: 36, borderRadius: 8, background: 'var(--accent)', border: '1.5px solid var(--ink)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', fontFamily: 'Caveat', fontSize: 22, fontWeight: 700, flex: '0 0 auto'}}>P</div>
          ...
          <div style={{display: 'flex', gap: 12, justifyContent: 'flex-end'}}>
            <div style={{padding: '10px 14px', maxWidth: '85%', borderRadius: '12px 12px 4px 12px', background: 'var(--ink)', color: 'var(--paper)', fontSize: 13.5}}>dev-circle</div>
          </div>
          ...
          <div style={{display: 'flex', gap: 12, alignItems: 'flex-start'}}>
            <div style={{width: 36, height: 36, borderRadius: 8, background: 'var(--accent)', border: '1.5px solid var(--ink)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', fontFamily: 'Caveat', fontSize: 22, fontWeight: 700, flex: '0 0 auto'}}>P</div>
            <Box style={{padding: '10px 14px', maxWidth: '85%', borderRadius: '12px 12px 12px 4px'}}>
              <div style={{fontSize: 13.5}}>dev-circle 👌 e do que vocês falam por lá?</div>
              <div style={{display: 'flex', flexWrap: 'wrap', gap: 6, marginTop: 10}}>
                {['Engenharia', 'Design', 'Produto', 'Vendas', 'Marketing', 'Outro'].map((t, i) => (
          ...
          <div style={{display: 'flex', gap: 12, alignItems: 'flex-start'}}>
            ...
            <Box style={{padding: '10px 14px', borderRadius: '12px 12px 12px 4px'}}>
              <div style={{fontSize: 13.5}}>Massa. <span className="wf-mark">Aqui vão 3 templates</span> pra começar — escolhe um (dá pra mudar tudo depois):</div>
              <div style={{display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 8, marginTop: 12}}>
                {[
                  {n: 'Q&A focado', d: 'feed estilo stackoverflow + cursos'},
                  {n: 'Showcase + crítica', d: 'visual-heavy, com galeria'},
                  {n: 'Curso + cohort', d: 'cursos no centro, comunidade gira em torno'},
                ].map((t, i) => (
