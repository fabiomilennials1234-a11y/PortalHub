    ...
    <div style={{padding: '24px 36px', height: 'calc(100% - 60px)', overflow: 'hidden'}}>
      <Box style={{padding: 20}}>
        <div style={{display: 'flex', gap: 20, alignItems: 'flex-start'}}>
          ...
          <div style={{flex: 1}}>
            ...
            <Mono style={{color: 'var(--ink-mid)'}}>@maria · Eng @ acme · entrou em jan/2025</Mono>
            <div style={{display: 'flex', gap: 6, marginTop: 8}}>
              <LvlBadge lvl={12} />
              <Pill style={{fontSize: 11}}>🏆 top 5 da semana</Pill>
              <Pill yellow style={{fontSize: 11}}>🔥 47 dias seguidos</Pill>
            </div>
          </div>
          <Btn>seguir</Btn>
      ...
      <div style={{display: 'grid', gridTemplateColumns: '1.4fr 1fr', gap: 16, marginTop: 16}}>
        <Box style={{padding: 14}}>
          ...
          {[
            {t: 'Como vocês modelam multi-tenancy?', c: '❓', up: 34, com: 12, t2: '2h'},
            {t: 'RLS em prod — pegadinhas', c: '💬', up: 28, com: 19, t2: '3d'},
            {t: 'Webhooks idempotentes — pattern', c: '📚', up: 47, com: 22, t2: '1sem'},
          ].map((p, i) => (
            <div key={i} style={{padding: '12px 0', borderBottom: '1px dashed var(--line-faint)'}}>
              ...
              <div style={{fontSize: 12, color: 'var(--ink-mid)', marginTop: 4}}>↑ {p.up} · 💬 {p.com}</div>
            </div>
          ))}
        </Box>
    ...
    <div style={{padding: '36px 60px', height: 'calc(100% - 60px)', overflow: 'hidden'}}>
      <div style={{display: 'grid', gridTemplateColumns: '380px 1fr', gap: 30}}>
        ...
        <div style={{position: 'relative'}}>
          <Box rough style={{padding: 0, overflow: 'hidden', borderWidth: 3, transform: 'rotate(-1.5deg)'}}>
            ...
            <div style={{padding: 16, background: 'var(--paper)'}}>
              ...
              <div style={{display: 'grid', gap: 6, marginTop: 6, fontSize: 13}}>
                {[['📝 Postar', 90], ['💬 Responder', 80], ['🎓 Aprender', 70], ['🚀 Ship', 60]].map(([l, v]) => (
        ...
        <div>
          ...
          <div style={{display: 'flex', flexDirection: 'column', gap: 8, marginTop: 8}}>
            {[
              ['💬', 'respondeu', '"Como vocês modelam multi-tenancy?"', '+15 pts'],
              ['🎓', 'concluiu', 'Lição "Forms e composição"', '+12 pts'],
              ['📝', 'postou', '"RLS em prod — pegadinhas"', '+15 pts'],
            ].map((a, i) => (
    ...
    <div style={{padding: '24px 36px', height: 'calc(100% - 60px)', overflow: 'hidden'}}>
      ...
      <div style={{display: 'flex', gap: 18, marginTop: 12, padding: 18, border: '1.5px solid var(--ink)', borderRadius: 8, background: 'var(--paper-2)', alignItems: 'center'}}>
        ...
        <div style={{textAlign: 'right'}}>
          ...
          <Mono style={{color: 'var(--ink-mid)'}}>PTS · LVL 12 · TOP 5</Mono>
      ...
      <div style={{display: 'grid', gridTemplateColumns: 'repeat(6, 1fr)', gap: 10, marginTop: 10}}>
        {[
          ...
          {d: 'mar/25', t: 'Lvl 5', desc: 'desbloqueou DMs', color: 'var(--paper-2)'},
          {d: 'mai/25', t: '100 respostas', desc: 'badge 💬', color: 'var(--paper-2)'},
          {d: 'jul/25', t: 'Streak 30d', desc: '🔥 30', color: 'var(--accent-2)'},
          {d: 'set/25', t: 'Top 10 mês', desc: '🏆', color: 'var(--paper-2)'},
          {d: 'out/25', t: 'Lvl 10', desc: 'curso completo', color: 'var(--paper-2)'},
          {d: 'jan/26', t: '1k pts', desc: 'milestone', color: 'var(--accent-2)'},
          {d: 'fev/26', t: 'Top 3 sem.', desc: '#3 da semana', color: 'var(--paper-2)'},
          {d: 'abr/26', t: 'Lvl 12', desc: 'hoje', color: 'var(--accent)', text: '#fff'},
          {d: '???', t: 'Lvl 13', desc: 'em 320 pts', color: 'transparent', dashed: true},
          {d: '???', t: 'Top 1', desc: '720 pts atrás', color: 'transparent', dashed: true},
        ].map((s, i) => (
          <div key={i} style={{
